...
const isMobileUI = width < 768; // FIXED: width use kiya screenWidth ki jagah
...
// FIXED: FeatureCard props structure correct kiya
        ...
        <Animated.View
            style={[
                styles.card,
                {
                    ...
                    // Mobile fix: properly width apply ki
...
export default function FeaturesSection() {
    ...
    return (
        <View
            nativeID="features" // web par 'id' ki jagah nativeID better hai
            style={[
                styles.section,
                { backgroundColor: isDark ? Colors.carbon900 : Colors.light.surfaceAlt },
                isMobileUI && { paddingVertical: 60, paddingHorizontal: 16 }
            ]}
        >
            <View style={[styles.header, isMobileUI && { marginBottom: 40 }]}>
                ...
                <Text
                    style={[
                        ...
                        isMobileUI && { fontSize: 26, lineHeight: 34 }
                    ]}
                >
                    {/* FIXED: Ternary logic theek ki */}
            ...
            <View style={[styles.grid, isWide && styles.gridWide, isMobileUI && { gap: 16 }]}>
...
_________________OLD CODE___________________________
// import React, { useRef, useEffect } from "react";
// import {
//     View,
//     Text,
